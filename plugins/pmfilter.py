...
# Replace this entire block in pmfilter.py

# pmfilter.py ফাইলের cb_handler ফাংশনের মধ্যে থাকা 'generate_stream_link' ব্লকটি প্রতিস্থাপন করুন

    elif lazyData.startswith("generate_stream_link"):
        user_id = query.from_user.id
        
        # ডাটাবেস থেকে watch online মোড স্ট্যাটাস চেক করুন
        is_premium_only = await mdb.get_watch_online_mode()

        if is_premium_only:
            # যদি মোড ON থাকে, তাহলে ব্যবহারকারী প্রিমিয়াম বা অ্যাডমিন কিনা তা পরীক্ষা করুন
            is_premium = await db.has_premium_access(user_id)
            if not (user_id in ADMINS or is_premium):
                await query.answer(
                    "😩ᴴᵉʸ, ᵇʳᵒ ʸᵒᵘ ᵃʳᵉ ⁿᵒᵗ ᵃ ᵖʳᵉᵐⁱᵘᵐ ᵘˢᵉʳ.😩\n🤏ᵀʰⁱˢ ᶠᵉᵃᵗᵘʳᵉ ⁱˢ ᵒⁿˡʸ ᶠᵒʳ ᵖʳᵉᵐⁱᵘᵐ ᵘˢᵉʳˢ.🤏",show_alert=True
                )
                return

        # যদি মোড OFF থাকে বা ব্যবহারকারী অনুমোদিত হয়, তাহলে লিঙ্ক তৈরি করুন
...
# ============
       ...
       #@Deendayal_dhakad
        ...
        buttons = [
            [
                InlineKeyboardButton('ᴄᴀᴛᴄʜ ᴛʜᴇ ɪᴍᴏᴊɪ 🎮', url='https://t.me/Hell_King_69_Bot/CatchTheEmoji'),
                InlineKeyboardButton('ᴄʀᴏꜱꜱ ᴛʜᴇ ʀᴏᴀᴅ 🐔', url='https://t.me/Hell_King_69_Bot/CrossTheRoad')
            ],
            [
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
                    text=script.GAMES_TXT, # You can change this text
                    reply_markup=reply_markup
                )
        await query.answer()
...
#Deendayal403
        ...
        buttons = [[
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ 📜', url='https://github.com/DeveloperSubhadeep1/hell-king-V7.6.25'),
